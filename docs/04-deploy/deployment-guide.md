...
- 로그인과 가족 공간·구성원 관리
- 일정·가계부·디데이·목표를 요약하는 개인화 홈 대시보드
- 일정, 반복 일정, 알림 설정
...
2. 홈 대시보드 요약 데이터와 구성원별 카드 순서 저장
3. 관리자 로그인과 가족 구성원 초대
4. 일정 생성·수정·삭제와 구성원 색상 구분
5. Google Calendar 연결, 내보내기, 연결 해제
6. 가족 장부와 개인 장부 권한 분리
7. 가족/개인 목표 및 디데이 생성·수정·삭제 권한 분리
8. iPhone Safari와 Android Chrome에서 44px 터치 영역 확인
